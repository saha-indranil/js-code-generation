...
# Create the base LM.
# Only activate the LayerNorm layers in the LM for training.
# Train the LM on the training dataset.
...
# load the LNTuning configuration
# load the base LM
# merge the LNTuning weights into the base LM using the PEFT config
